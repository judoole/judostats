...
function GitHubCorner() {
  ...
  return (
    <a
      ...
      className="fixed top-4 right-4 z-50 w-10 h-10 bg-gray-900 rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors shadow-lg hover:shadow-xl"
